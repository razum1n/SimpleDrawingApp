package com.laurirantala.simpledrawingapp
...
class MainActivity : AppCompatActivity() {
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    Toast.makeText(
                        this,
                        "You can now read storage files",
                        Toast.LENGTH_LONG
                    ).show()
    ...
    private fun setupButtons() {
        ...
        val ibGallery: ImageButton = findViewById(R.id.ib_image)
        ...
        val ibSave: ImageButton = findViewById(R.id.ib_save_image)
    ...
    private fun requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            showRationaleDialog(
                "Simple Drawing App",
                "Simple Drawing App needs to Access Your External Storage"
            )
        } else {
        ...
        withContext(Dispatchers.IO) {
            if (mBitmap != null) {
                try {
                    ...
                    val f =
                        File(externalCacheDir?.absoluteFile.toString() + File.separator + "SimpleDrawingApp_" + System.currentTimeMillis() / 1000 + ".png")
                    ...
                    runOnUiThread {
                        ...
                        if (result.isNotEmpty()) {
                            ...
                            Toast.makeText(
                                this@MainActivity,
                                "Somethig went wrong saving the file",
                                Toast.LENGTH_SHORT
                            ).show()
                        }
                    }
